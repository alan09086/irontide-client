...
pub fn run(path: &Path) -> anyhow::Result<()> {
    ...
    match &meta {
        irontide::core::TorrentMeta::V1(t) => print_v1_details(t),
        irontide::core::TorrentMeta::V2(t) => print_v2_details(t),
        irontide::core::TorrentMeta::Hybrid(v1, v2) => {
            print_v1_details(v1);
...
fn meta_name(meta: &irontide::core::TorrentMeta) -> &str {
    match meta {
        irontide::core::TorrentMeta::V1(t) => &t.info.name,
        irontide::core::TorrentMeta::V2(t) => &t.info.name,
        irontide::core::TorrentMeta::Hybrid(v1, _) => &v1.info.name,
    }
}

fn print_v1_details(t: &irontide::core::TorrentMetaV1) {
...
fn print_v2_details(t: &irontide::core::TorrentMetaV2) {
