...
window.MOCK = (() => {
  const torrents = [
    {
      ...
      savePath: '/mnt/storage/Torrents/Linux',
    ...
    },
    {
      ...
      savePath: '/mnt/storage/Torrents/Software',
    ...
    },
    {
      ...
      savePath: '/home/alan/Downloads/Papers',
    ...
    },
    {
      ...
      savePath: '/home/alan/Downloads/Books',
    ...
    },
    {
      ...
      savePath: '/mnt/storage/Torrents/Video',
  ...
  const categories = [
    ...
    { id: 'Linux', name: 'Linux ISOs', count: 3, pathRule: '/mnt/storage/Torrents/Linux' },
    { id: 'Software', name: 'Software', count: 3, pathRule: '/mnt/storage/Torrents/Software' },
    { id: 'Video', name: 'Video', count: 2, pathRule: '/mnt/storage/Torrents/Video' },
    { id: 'Books', name: 'Books', count: 2, pathRule: '/home/alan/Downloads/Books' },
    { id: 'Papers', name: 'Research Papers', count: 1, pathRule: '/home/alan/Downloads/Papers' },
    { id: 'Datasets', name: 'Datasets', count: 1, pathRule: '/mnt/storage/Datasets' },
  ...
  const rssRules = [
    { id: 'ar1', name: 'Ubuntu auto-download', enabled: true, mustContain: 'ubuntu-*-amd64.iso', mustNotContain: 'beta|rc', episodeFilter: '', smartFilter: true, category: 'Linux', savePath: '/mnt/storage/Torrents/Linux', feeds: ['Linux ISOs'] },
    { id: 'ar2', name: 'Medical research',     enabled: true, mustContain: 'CORD-*|biomed-*',    mustNotContain: '',        episodeFilter: '', smartFilter: false, category: 'Papers', savePath: '/home/alan/Downloads/Papers', feeds: ['Academic Torrents'] },
    { id: 'ar3', name: 'OSM weekly',            enabled: false, mustContain: 'OSM-Planet-Weekly-*', mustNotContain: '',       episodeFilter: '', smartFilter: false, category: 'Datasets', savePath: '/mnt/storage/Datasets', feeds: ['Public Datasets'] },
  ];
  ...
  const logs = [
    ...
    { t: '07:39:51.002', level: 'DEBUG',  msg: 'Loaded 12 torrents from /home/alan/.config/irontide/state.bin' },
    { t: '07:39:50.001', level: 'INFO',   msg: 'Config loaded from /home/alan/.config/irontide/config.toml' },
