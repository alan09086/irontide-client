          ...
          {tab === 'general' && (
            <div>
              <Card title="Transfer">
                ...
                <Row label="Status"      value={<span style={{display:'inline-flex', alignItems:'center', gap: 6, textTransform:'capitalize'}}><IT.StatusDot tone={torrent.status}/>{torrent.status}</span>}/>
