              ...
              {tab==='behavior' && (
                <>
                  <Group title="Interface">
                    <Field label="Theme"><IT.Select value="Auto" options={['Auto','Light','Dark']}/></Field>
                    <Field label="Skin"><IT.Select value="Tide" options={['Tide','Forge','Abyss']}/></Field>
                    <Field label="Density"><IT.Select value="Balanced" options={['Compact','Balanced','Spacious']}/></Field>
              ...
              {tab==='downloads' && (
                <>
                  <Group title="Save locations">
                    <Field label="Default save path"><IT.TextInput mono value="/Users/claude/Downloads/Torrents" width={360}/><IT.Btn variant="solid" size="sm">Browse…</IT.Btn></Field>
                    <Field label="Keep incomplete in separate folder"><IT.Toggle on/></Field>
                    <Field label="Incomplete save path"><IT.TextInput mono value="/Users/claude/Downloads/.incomplete" width={360}/><IT.Btn variant="solid" size="sm">Browse…</IT.Btn></Field>
                  ...
                  <Group title="Torrent file handling">
                    <Field label="Watched folder" hint="Auto-add .torrent files dropped here"><IT.TextInput mono value="/Users/claude/Downloads/.watch" width={360}/><IT.Btn variant="solid" size="sm">Browse…</IT.Btn></Field>
                    <Field label="Copy .torrent files to"><IT.TextInput mono value="/Users/claude/Library/IronTide/torrents" width={360}/></Field>
                    <Field label="Move .torrent files of completed downloads"><IT.TextInput mono value="/Users/claude/Library/IronTide/done" width={360}/></Field>
              ...
              {tab==='connection' && (
                <>
                  ...
                  <Group title="IP Filtering">
                    ...
                    <Field label="Filter file"><IT.TextInput mono value="/Users/claude/Library/IronTide/ipfilter.dat" width={360}/></Field>
              ...
              {tab==='advanced' && (
                <>
                  ...
                  <Group title="Export configuration">
                    <Field label="Configuration file"><span className="mono" style={{fontSize:12, color:'var(--fg-2)'}}>/Users/claude/.config/irontide/config.toml</span><IT.Btn variant="solid" size="sm">Reveal</IT.Btn></Field>
